  ...
  return (
    <div className='homeexplore'>
      <div className="explore-header">
        <p>{t('exploreOur')} <span>{t('furniture')}</span> {t('range')}:</p> {/* Çeviriyi kullan */}
      </div>
